<x-app-layout>
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            ...
                            <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
                                data-bs-target="#modal-students" aria-label="إنشاء دفعة جديدة">
                                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
    ...
    @push('modals')
    <div class="modal modal-blur fade" id="modal-students" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">دفعة جديدة</h5>
    ...
    <x-slot name="scripts">
        <script>
            document.addEventListener('livewire:init', function() {
                ...
                Livewire.on('studentCreated', function() {
